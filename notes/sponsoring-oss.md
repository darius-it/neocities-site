---
id: IH0Cuw7d0nU
title: sponsoring oss projects 
description: How I am going about supporting open source 
author: Darius 
visibility: public
created: 2026-06-19T13:55:36+00:00
---
...
- **5€** to [KDE e.V.](https://ev.kde.org/) for their contributions to Plasma, a DE I used for a long time
- **$15** to [YaLTeR (Ivan Molodetskikh)](https://github.com/yalter) for their incredible work on [Niri](https://github.com/niri-wm/niri), which was a gamechanger for my workflow and has not failed me ever since I switched to it
- **$5** to [Giacomo Cavalieri](https://github.com/giacomocavalieri) for their contributions to the Gleam ecosystem, and their [awesome article about snapshot testing](https://giacomocavalieri.me/writing/testing-can-be-fun-actually) which showed how fun testing can be if you rethink how it works

## Future plans

Here are some people/projects that I would love to sponsor in the future, in no particular order:
- [antfu](https://github.com/antfu) for their insane contributions to the JS/Vite/Vue ecosystem
- [gabehf](https://github.com/gabehf) for their work on [Koito](https://github.com/gabehf/Koito), which has completely replaced last.fm for me
- [Inrixia](https://github.com/Inrixia) for their work on [TidaLuna](https://github.com/Inrixia/TidaLuna), a client mod for the Tidal client which has elevated my Tidal listening experience exponentially
- [Glance](https://github.com/glanceapp/glance) for making my browser's homepage so much nicer :)
- [kawaiiDango](https://github.com/kawaiiDango) for creating [PanoScrobbler](https://github.com/kawaiiDango/pano-scrobbler), which has been great for integrating with Koito (mentioned above) and taking music tracking into my own hands instead of relying on 3rd party services
...
- [anthonyhfm](https://github.com/anthonyhfm)
